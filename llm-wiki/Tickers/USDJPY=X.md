...
- **David Lin** — [Yen Bailout Crisis: Bond Market Gets Crushed, Worse To Come \| Steve Hanke](https://www.youtube.com/watch?v=sIFVn-StiBk) — 2026-08-06, David Lin: "the yen would continue going down because the fundamentals point to going down."
- **Patrick Ceresna** (action=`watch`, dir=`down`, target=`160`, tf=`unspecified`) — [MacroVoices #537 Brent Johnson: There’s No Turning Back](https://www.youtube.com/watch?v=s7IDIRbZa2o) — 2026-06-19, [Patrick Ceresna](../People/patrick-ceresna.md): "The 160 level on the US yen has been a rock solid overhead resistance where we have seen numerous interventions happen in the past and yet here we are quietly crawling above that level looking like the yen may have a wh…"
