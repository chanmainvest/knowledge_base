...
- **Chris Semenuk** (action=`buy`, dir=`up`, tf=`unspecified`) — [The Longest US Manufacturing Recession in History is Finally Over \| Chris Semen…](https://www.youtube.com/watch?v=aS6W2GJ2AzA) — 2026-06-18, [Chris Semenuk](../People/chris-semenuk.md): "Gates is you know, Gates, the symbol is GTES, it's it's it's a poster child for this for for what I've just outlined."
- **Chris Semenuk** (action=`watch`, dir=`up`, tf=`short`) — [The Longest US Manufacturing Recession in History is Finally Over \| Chris Semen…](https://www.youtube.com/watch?v=aS6W2GJ2AzA) — 2026-06-18, [Chris Semenuk](../People/chris-semenuk.md): "companies like Gates, which makes belts and chains and drives that go inside a factory, they have started to say that as the year has started, we are starting to see I think a pick up in orders after three and a half ye…"
